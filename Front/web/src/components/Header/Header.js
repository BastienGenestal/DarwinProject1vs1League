          ...
          <MDBNavbar color="rgba-black-light" dark expand="md" fixed="top">
            <MDBNavbarBrand>
              <strong
                ...
                style={{
                  borderRight: "rgba(93, 228, 255, 0.75) 1px solid",
                  paddingRight: "20px",
                }}
              >
                Darwin 1v1 League
            ...
            <MDBCollapse id="navbarCollapse3" isOpen={this.state.isOpen} navbar>
                ...
                <MDBNavItem className="leaderboard-tab">
                  <MDBDropdown>
                    ...
                    <MDBDropdownMenu>
                      ...
                      >
                        <Link to="/leaderboard/pc">PC</Link>
                      </MDBDropdownItem>
                      <MDBDropdownItem
                        onClick={() =>
                          history.push({
                      ...
                      >
                        <Link to="/leaderboard/ps4">PS4</Link>
                      </MDBDropdownItem>
                      <MDBDropdownItem
                        onClick={() =>
                          history.push({
                      ...
                      >
                        <Link to="/leaderboard">Global</Link>
                      </MDBDropdownItem>
                    </MDBDropdownMenu>
                  </MDBDropdown>
                </MDBNavItem>
              ...
              <MDBNavbarNav right className="right">
                <MDBNavItem className="socials">
                  <a
                    href="https://www.youtube.com/watch?v=0tCrpVTmb-M"
                    target="_blank"
                ...
                <MDBNavItem className="socials">
                  <a
                    href="https://www.twitch.tv/darwin1v1league/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                ...
                <MDBNavItem className="socials">
                  <a
                    href="https://www.instagram.com/darwin1v1league/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                ...
                <MDBNavItem className="socials">
                  <a
                    href="https://twitter.com/1v1Darwin"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
